...
#50 Utolsó menedék: Keresd meg az utolsó menedéket a pályán, ahol biztonságban érezheted magadat és gyógyíthatsz a következő szintre való átjutás előtt!");
        ...
        private void Teszteleskiiratasa()
        {
            ...
            string[] opciok = { "Pisztoly", "AK-47", "Fémcső", "Vodkásüveg", "Kötszer", "Koktél", "Fájdalomcsillapító", "Joint", "Lockpick", "Golyóálló mellény" };
            Menu menu = new Menu(prompt, opciok);
            int Megjelolt = menu.Futas();
        ...
        private void Vodkaskiiratasa()
        {
            Clear();
            WriteLine("Vokdásüveg");
            ReadKey(true);
            MainFuttatasa();
        }
        ...
        private void Fajdalomcsillkiiratasa()
        {
            Clear();
            WriteLine("Fájdalomcsillapító");
            ReadKey(true);
            MainFuttatasa();
        }
        ...
        private void Lockpickkiiratasa()
        {
            Clear();
            WriteLine("Lockpick");
            ReadKey(true);
        ...
        private void Golyoallokiiratasa()
        {
            Clear();
            WriteLine("Golyóálló mellény");
            ReadKey(true);
            MainFuttatasa();
        }
    }
