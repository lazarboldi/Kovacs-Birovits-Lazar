...
public class FiokKezeles
{
    ...
    public void CsokkentemKonnyu(string nev) => ModifyFiokData(nev, 7, -25);
    public void CsokkentemKozepes(string nev) => ModifyFiokData(nev, 7, -25);
    public void CsokkentemNehez(string nev) => ModifyFiokData(nev, 7, -50);
